...
use ecclesia_domain::{Posture, VoiceKind};

use super::chat::{
    ChatEndpoint, ChatResponse, apply_headers, chat_completions_url, http_client, is_openrouter,
};
use super::prompts;
...
impl JudgeHub {
    ...
    pub fn load() -> Self {
        tracing::info!("using the word gate; Jev and OpenRouter stay off until a later spec");
        Self::word_gate()
    }
...
mod tests {
    use super::*;
    use crate::chat::chat_completions_url;
